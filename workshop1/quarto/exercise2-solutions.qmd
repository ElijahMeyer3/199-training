...
Error 1: ! <text>:5:15: unexpected 'in' labs( x = Price in

Fix: put quotes around strings of text

Explanation:

------------------------------------------------------------------------

Error 2: ! <text>:9:7: unexpected symbol Based on

Fix: Remove text from code chunk

Explanation:

------------------------------------------------------------------------

Error 3: Error in `ggplot()`: ! could not find function "ggplot"

Fix: Change eval = T; remove eval = ; tell students to library packages

Explanation:

------------------------------------------------------------------------

Error 4: ! Cannot add <ggproto> objects together i Did you forget to add this object to a <ggplot> object?
